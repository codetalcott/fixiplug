/**
 * Error Recovery Skill Plugin (Skill-Only)
 *
 * This is a "skill-only" plugin that provides NO hooks or APIs.
 * Instead, it teaches LLM agents how to handle errors, implement retry logic,
 * perform graceful degradation, and recover from failures.
 *
 * @module plugins/error-recovery-skill
 *
 * Purpose:
 * - Teach agents error handling patterns
 * - Implement retry logic with exponential backoff
 * - Handle timeout scenarios
 * - Perform optimistic updates with rollback
 * - Graceful degradation strategies
 *
 * @example
 * // This plugin provides no hooks - it only teaches agents via skill metadata
 * // The agent learns to handle failures across all plugin operations
 */

export default function errorRecoverySkill(ctx) {
  // NO hooks registered - this is a pure skill plugin
  // The skill metadata below teaches agents error handling patterns
  ...
  return {
    skill: {
      ...
      instructions: `# Error Handling and Recovery Skill
