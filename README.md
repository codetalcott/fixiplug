...
Optional Typescript usage with FixiPlugs:

```js
import fixi from './fixiplug';

// Function-style plugin with TypeScript
function myTypedPlugin(ctx: FixiPlug.PluginContext) {
  // IDE now provides autocompletion and type checking
  ctx.on('init', (event) => {
    // Safe to use ctx methods with proper typing
    console.log(`Plugin ${ctx.pluginName} initialized`);
  });
  
  // Type checking on event handlers
  ctx.on('before', (event) => {
    if (event.target) {
      // TypeScript would suggest available properties
    }
    return event;
  });
}

// Object-style plugin with TypeScript
const objectPlugin: FixiPlug.PluginInstance = {
  name: 'myTypedObjectPlugin',
  version: '1.0.0',
  dependencies: ['core'],
  ...
  // All hook handlers properly typed
  init(event) {
    return event;
  }
};

// Register plugins using fixiplug
fixiplug.use(myTypedPlugin);
fixiplug.use(objectPlugin);
```
...
fixiplug-inspector.js - Plugin behavior inspection
fixiplug-hotreload.js - Hot reloading for development

### Security

```js
import fixi from './fixiplug.js';
import fixiSecurity from './fixi-security.js';

// Register the security plugin first (before any other plugins)
fixiplug.use(fixiSecurity);

// Now register other plugins - they'll be protected
...
## About Fixi.js
The following describes the Fixi library, here for convenience during fixiplug dev; we'll remove this once we have a working fixiplug v1.
...
<td>
<a href="#fxinit">[`fx:init`](#fxinit)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxinited">[`fx:inited`](#fxinited)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxprocess">[`fx:process`](#fxprocess)</a>
</td>
<td>
...
<td>
<a href="#fxconfig">[`fx:config`](#fxconfig)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxbefore">[`fx:before`](#fxbefore)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxafter">[`fx:after`](#fxafter)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxerror">[`fx:error`](#fxerror)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxfinally">[`fx:finally`](#fxfinally)</a>
</td>
<td>
...
<tr>
<td>
<a href="#fxswapped">[`fx:swapped`](#fxswapped)</a>
</td>
<td>
...
<!-- @example -->
### Click-to-Edit Example <!-- fi src/core/README.md -->
...
<!-- @example -->
### Delete-Row Example <!-- fi src/core/README.md -->
...
<!-- @example -->
### Lazy-Loading Example <!-- fi src/core/README.md -->
...
{
  "sections": [
    {"title": "Minimalism", "filepath": "src/core/README.md", "anchor": "#minimalism"},
    {"title": "Installing", "filepath": "src/core/README.md", "anchor": "#installing"},
    {"title": "Support", "filepath": "src/core/README.md", "anchor": "#support"},
    {"title": "API", "filepath": "src/core/README.md", "anchor": "#api"},
    {"title": "Attributes", "filepath": "src/core/README.md", "anchor": "#attributes"},
    {"title": "Events", "filepath": "src/core/README.md", "anchor": "#events"},
    {"title": "Examples", "filepath": "src/core/README.md", "anchor": "#examples"},
    {"title": "Extensions", "filepath": "src/core/README.md", "anchor": "#extensions"},
    {"title": "License", "filepath": "src/core/README.md", "anchor": "#license"}
  ]
}
```
