...
This document outlines promising plugin ideas specifically designed to enable LLM agents to interact with FixiPlug-powered applications.
...
- `api:queryByIntent` - Find elements by purpose ("submit button", "email field")
